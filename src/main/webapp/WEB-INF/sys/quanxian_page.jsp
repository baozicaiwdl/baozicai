...
<body>
	<table class='layui-table'
		lay-data="{url:'quanxian_list',toolbar:'#tollbar', page:true ,id:'serlist'}"
		lay-filter="test">
		<thead>
			<tr>
				<th lay-data="{type:'checkbox'}"></th>
				<th lay-data="{field:'customerid'}">岗位ID</th>
				<th lay-data="{field:'customername'}">岗位code</th>
				<th lay-data="{field:'customerpassword'}">岗位名称</th>
				<th lay-data="{field:'customerphone'}">所属岗位</th>
				<th
