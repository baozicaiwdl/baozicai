...
<body>
	<table class='layui-table'
		lay-data="{url:'bumen_list',toolbar:'#tollbar', page:true ,id:'serlist'}"
		lay-filter="test">
		<thead>
			<tr>
				<th lay-data="{type:'checkbox'}"></th>
				<th lay-data="{field:'customerid'}">部门id</th>
				<th lay-data="{field:'customername'}">部门名称</th>
				<th lay-data="{field:'customerpassword'}">部门经理</th>
				<th lay-data="{field:'customerphone'}">现有人员</th>
				<th
	...
	<div hidden id='insert_user_div' >
		...
		<div class=layui-form-item>
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input type='text' id='insert_id' name='user_id' autocomplete='off'
		...
		<div class=layui-form-item>
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input type='text' id='insert_name' name='user_name' autocomplete='off'
						class='layui-input'>
				</div>
			</div>
		</div>
		...
		<div class=layui-form-item>
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input type='text' id='insert_type' name='user_pass' autocomplete='off'
						class='layui-input'>
				</div>
			</div>
		</div>
	...
	<div hidden class=" layui-form" id='update_user_div' lay-filter="upd_test">
		<div class=layui-form-item>
			<div class="layui-inline">
				<label class="layui-form-label">编号</label>
				<div class="layui-input-inline">
  ...
  <a class="layui-btn layui-btn-xs" lay-event="edit1" >分配人员</a>
		...
		case 'add':
			layer.open({
				...
				btn1:function(index, layero){
					...
					$.post("user_list_add",formdata,function(d){
						 form.render();
						 table.reload("serlist", {
								url : "user_list",
								type : "post",
		...
		case 'upd':
			...
			layer.open({
				...
				btn1:function(index, layero){
					...
					$.post("user_list_update",formdata,function(d){
						 form.render();
						 table.reload("serlist", {
								url : "user_list",
								type : "post",
