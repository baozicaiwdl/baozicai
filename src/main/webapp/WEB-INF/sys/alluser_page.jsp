...
<body>
	<table class='layui-table'
		lay-data="{url:'alluser_list',toolbar:'#tollbar', page:true ,id:'serlist'}"
		lay-filter="test">
		<thead>
			<tr>
  ...
  <a class="layui-btn layui-btn-xs" lay-event="edit1" >回访</a>
<a class="layui-btn layui-btn-xs layui-btn-danger" lay-event="edit23" >放弃客户</a>
