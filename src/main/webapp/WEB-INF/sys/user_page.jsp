...
<body>
	<table class='layui-table'
		lay-data="{url:'user_list',toolbar:'#tollbar', page:true ,id:'serlist'}"
		lay-filter="test">
		<thead>
			<tr>
				<th lay-data="{type:'checkbox'}"></th>
				<th lay-data="{field:'user_id'}">编号</th>
				<th lay-data="{field:'user_name'}">用户</th>
...
<button type="button" class="layui-btn layui-btn-sm layui-btn-warm" lay-event="see">
  <i class="layui-icon">&#xe683;</i> 分配/查看岗位
</button>
</script>
